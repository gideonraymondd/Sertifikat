...
<body>
    ...
    <div class="container" style="padding-top: 20px;">
        <form action="updateprofile.php" method="POST">
            <img src="Foto/profile.jpg" alt="Avatar" class="avatar">
            <div class="card shadow mb-4" style="width: 113%; padding: 5px 20px 10px 20px;">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <input type="date" value="<?php echo $data["tanggal lahir"];?>" class="form-control" name="tglLahir"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="text" value="<?php echo $data["jabatan"];?>" class="form-control" name="jabatan" value="Kepala Prodi Informatika">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
